...
export default function Planificador() {
  ...
  return (
    <>
      <div className="relative flex justify-center  bg-blue-400 w-screen h-screen ">
        <div className="absolute flex  w-4/5 p-8">
          <Link to="/principal">
            <ArrowLeftIcon className="w-8 h-8 cursor-pointer text-white rounded-full bg-red-500  p-1.5 hover:bg-red-700  transition ease-in duration-200" />
          </Link>
