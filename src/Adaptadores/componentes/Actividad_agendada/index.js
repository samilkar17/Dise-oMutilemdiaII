...
export default function ActividadAgendada() {
  ...
  return (
    <>
      <h1 className="  text-white font-body text-xl text-center mb-8">
      ...
      <div className="scrollbar-thin scrollbar-thumb-blue-700 scrollbar-track-blue-300 overflow-y-scroll scrollbar-thumb-rounded-full scrollbar-track-rounded-full px-2 h-4/5">
        <FlipMove>
          {!activities ? (
            <p className="font-body text-center text-xl text-indigo-200">
              Cargando...
            </p>
          ) : size(activities) === 0 ? (
            <h3 className="font-body text-center text-xl text-indigo-200">
